...
struct update_data_t
{
  ...
  float footrotations[18];//first 9 is left foot second 9 is right foot
  float yaw;
  float weights[12];
...
EXTERNC void update_problem_data(double* p, double* v, double* q, double* w, double* r, double *footrotations, double yaw, double* weights, double* state_trajectory, double* Alpha_K, int* gait);
