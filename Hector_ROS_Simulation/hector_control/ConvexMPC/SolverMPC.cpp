...
typedef Eigen::Matrix<fpt, 3, 3, Eigen::RowMajor> Matrix3fpt;
...
void solve_mpc(update_data_t *update, problem_setup *setup)
{
  ...
  Eigen::Map<Matrix3fpt>(R_foot_L.data()) = Eigen::Map<const Matrix3fpt>(update->footrotations);
// Map the next 9 elements of footrotations to R_foot_R
  Eigen::Map<Matrix3fpt>(R_foot_R.data()) = Eigen::Map<const Matrix3fpt>(update->footrotations + 9);



  // R_foot_L(0,0) = update->footrotations[0];
  // R_foot_L(0,1) = update->footrotations[1];
  // R_foot_L(0,2) = update->footrotations[2];
  // R_foot_L(1,0) = update->footrotations[3];
  // R_foot_L(1,1) = update->footrotations[4];
  // R_foot_L(1,2) = update->footrotations[5];
  // R_foot_L(2,0) = update->footrotations[6];
  // R_foot_L(2,1) = update->footrotations[7];
  // R_foot_L(2,2) = update->footrotations[8];

  // R_foot_R(0,0) = update->footrotations[9];
  // R_foot_R(0,1) = update->footrotations[10];
  // R_foot_R(0,2) = update->footrotations[11];
  // R_foot_R(1,0) = update->footrotations[12];
  // R_foot_R(1,1) = update->footrotations[13];
  // R_foot_R(1,2) = update->footrotations[14];
  // R_foot_R(2,0) = update->footrotations[15];
  // R_foot_R(2,1) = update->footrotations[16];
  // R_foot_R(2,2) = update->footrotations[17];
