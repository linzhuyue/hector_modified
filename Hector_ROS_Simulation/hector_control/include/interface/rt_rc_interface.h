...
namespace RC_mode{
  ...
  constexpr int QP_STAND = 3; //this is balanced stand
  ...
  constexpr int FRONT_JUMP_OPT=22;
  constexpr int ONLINE_JUMP_OPT=24;
  constexpr int SITDOWN=23;
  constexpr int SHOWDEMO=17;
  constexpr int NMPC=18;
  constexpr int DAMP=19;
  // Experiment Mode
